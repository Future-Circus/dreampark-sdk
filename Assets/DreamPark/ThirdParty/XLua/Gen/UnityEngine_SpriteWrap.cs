...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineSpriteWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 12, 16, 0);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetScriptableObjectsCount", _m_GetScriptableObjectsCount);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetScriptableObjects", _m_GetScriptableObjects);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "AddScriptableObject", _m_AddScriptableObject);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "RemoveScriptableObjectAt", _m_RemoveScriptableObjectAt);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "SetScriptableObjectAt", _m_SetScriptableObjectAt);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetScriptableObjectsCount(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = gen_to_be_invoked.GetScriptableObjectsCount(  );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetScriptableObjects(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.ScriptableObject[] _scriptableObjects = (UnityEngine.ScriptableObject[])translator.GetObject(L, 2, typeof(UnityEngine.ScriptableObject[]));
                    
                        var gen_ret = gen_to_be_invoked.GetScriptableObjects( _scriptableObjects );
                        LuaAPI.xlua_pushuint(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_AddScriptableObject(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.ScriptableObject _obj = (UnityEngine.ScriptableObject)translator.GetObject(L, 2, typeof(UnityEngine.ScriptableObject));
                    
                        var gen_ret = gen_to_be_invoked.AddScriptableObject( _obj );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_RemoveScriptableObjectAt(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    uint _i = LuaAPI.xlua_touint(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.RemoveScriptableObjectAt( _i );
                        LuaAPI.lua_pushboolean(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_SetScriptableObjectAt(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    uint _i = LuaAPI.xlua_touint(L, 3);
                        ...
                        var gen_ret = gen_to_be_invoked.SetScriptableObjectAt( _obj, _i );
                        LuaAPI.lua_pushboolean(L, gen_ret);
        ...
        static int _g_get_textureRect(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Sprite gen_to_be_invoked = (UnityEngine.Sprite)translator.FastGetCSObj(L, 1);
                translator.PushUnityEngineRect(L, gen_to_be_invoked.textureRect);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
