...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineShaderWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 19, 6, 1);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetPropertyDefaultIntValue", _m_GetPropertyDefaultIntValue);
		    ...
		    Utils.BeginClassRegister(type, L, __CreateInstance, 31, 5, 3);
            ...
            Utils.RegisterFunc(L, Utils.CLS_IDX, "SetGlobalRayTracingAccelerationStructure", _m_SetGlobalRayTracingAccelerationStructure_xlua_st_);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_SetGlobalRayTracingAccelerationStructure_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 1)&& translator.Assignable<UnityEngine.Rendering.RayTracingAccelerationStructure>(L, 2)) 
                {
                    int _nameID = LuaAPI.xlua_tointeger(L, 1);
                    UnityEngine.Rendering.RayTracingAccelerationStructure _value = (UnityEngine.Rendering.RayTracingAccelerationStructure)translator.GetObject(L, 2, typeof(UnityEngine.Rendering.RayTracingAccelerationStructure));
                    
                    UnityEngine.Shader.SetGlobalRayTracingAccelerationStructure( _nameID, _value );
                    
                    
                    
                    return 0;
                }
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& translator.Assignable<UnityEngine.Rendering.RayTracingAccelerationStructure>(L, 2)) 
                {
                    string _name = LuaAPI.lua_tostring(L, 1);
                    UnityEngine.Rendering.RayTracingAccelerationStructure _value = (UnityEngine.Rendering.RayTracingAccelerationStructure)translator.GetObject(L, 2, typeof(UnityEngine.Rendering.RayTracingAccelerationStructure));
                    
                    UnityEngine.Shader.SetGlobalRayTracingAccelerationStructure( _name, _value );
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Shader.SetGlobalRayTracingAccelerationStructure!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetPropertyDefaultIntValue(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    int _propertyIndex = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.GetPropertyDefaultIntValue( _propertyIndex );
                        LuaAPI.xlua_pushinteger(L, gen_ret);
