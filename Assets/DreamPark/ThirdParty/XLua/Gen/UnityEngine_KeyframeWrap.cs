    ...
    public class UnityEngineKeyframeWrap 
    {
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 3 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3))
				{
					...
					translator.PushUnityEngineKeyframe(L, gen_ret);
				...
				{
				    translator.PushUnityEngineKeyframe(L, default(UnityEngine.Keyframe));
			        return 1;
				}
        ...
        static int _s_set_time(RealStatePtr L)
        {
		    try {
                ...
                translator.UpdateUnityEngineKeyframe(L, 1, gen_to_be_invoked);
