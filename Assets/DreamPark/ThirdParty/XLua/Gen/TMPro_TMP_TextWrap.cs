...
namespace XLua.CSObjectWrap
{
    ...
    public class TMProTMP_TextWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "textWrappingMode", _g_get_textWrappingMode);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "fontFeatures", _g_get_fontFeatures);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "emojiFallbackSupport", _g_get_emojiFallbackSupport);
            ...
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "textWrappingMode", _s_set_textWrappingMode);
            ...
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "fontFeatures", _s_set_fontFeatures);
            ...
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "emojiFallbackSupport", _s_set_emojiFallbackSupport);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "OnMissingCharacter", _e_OnMissingCharacter);
        ...
        static int _g_get_faceColor(RealStatePtr L)
        {
		    try {
                ...
                TMPro.TMP_Text gen_to_be_invoked = (TMPro.TMP_Text)translator.FastGetCSObj(L, 1);
                translator.PushUnityEngineColor32(L, gen_to_be_invoked.faceColor);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_outlineColor(RealStatePtr L)
        {
		    try {
                ...
                TMPro.TMP_Text gen_to_be_invoked = (TMPro.TMP_Text)translator.FastGetCSObj(L, 1);
                translator.PushUnityEngineColor32(L, gen_to_be_invoked.outlineColor);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_textWrappingMode(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                TMPro.TMP_Text gen_to_be_invoked = (TMPro.TMP_Text)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.textWrappingMode);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_fontFeatures(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                TMPro.TMP_Text gen_to_be_invoked = (TMPro.TMP_Text)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.fontFeatures);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_emojiFallbackSupport(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                TMPro.TMP_Text gen_to_be_invoked = (TMPro.TMP_Text)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushboolean(L, gen_to_be_invoked.emojiFallbackSupport);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_textWrappingMode(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                TMPro.TMP_Text gen_to_be_invoked = (TMPro.TMP_Text)translator.FastGetCSObj(L, 1);
                TMPro.TextWrappingModes gen_value;translator.Get(L, 2, out gen_value);
				gen_to_be_invoked.textWrappingMode = gen_value;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_fontFeatures(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                TMPro.TMP_Text gen_to_be_invoked = (TMPro.TMP_Text)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.fontFeatures = (System.Collections.Generic.List<UnityEngine.TextCore.OTL_FeatureTag>)translator.GetObject(L, 2, typeof(System.Collections.Generic.List<UnityEngine.TextCore.OTL_FeatureTag>));
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_emojiFallbackSupport(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                TMPro.TMP_Text gen_to_be_invoked = (TMPro.TMP_Text)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.emojiFallbackSupport = LuaAPI.lua_toboolean(L, 2);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _e_OnMissingCharacter(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    int gen_param_count = LuaAPI.lua_gettop(L);
                TMPro.TMP_Text.MissingCharacterEventCallback gen_delegate = translator.GetDelegate<TMPro.TMP_Text.MissingCharacterEventCallback>(L, 2);
                if (gen_delegate == null) {
                    return LuaAPI.luaL_error(L, "#2 need TMPro.TMP_Text.MissingCharacterEventCallback!");
                }
                
				
				if (gen_param_count == 2 && LuaAPI.xlua_is_eq_str(L, 1, "+")) {
					TMPro.TMP_Text.OnMissingCharacter += gen_delegate;
					return 0;
				} 
			...
			return LuaAPI.luaL_error(L, "invalid arguments to TMPro.TMP_Text.OnMissingCharacter!");
        }
