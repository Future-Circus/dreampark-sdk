...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineRigidbodyWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "PublishTransform", _m_PublishTransform);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_PublishTransform(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.PublishTransform(  );
        ...
        static int _g_get_collisionDetectionMode(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Rigidbody gen_to_be_invoked = (UnityEngine.Rigidbody)translator.FastGetCSObj(L, 1);
                translator.PushUnityEngineCollisionDetectionMode(L, gen_to_be_invoked.collisionDetectionMode);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_interpolation(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Rigidbody gen_to_be_invoked = (UnityEngine.Rigidbody)translator.FastGetCSObj(L, 1);
                translator.PushUnityEngineRigidbodyInterpolation(L, gen_to_be_invoked.interpolation);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
