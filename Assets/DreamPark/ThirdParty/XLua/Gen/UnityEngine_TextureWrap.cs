...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineTextureWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 2, 17, 10);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "graphicsTexture", _g_get_graphicsTexture);
        ...
        static int _m_SetStreamingTextureMaterialDebugProperties_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    int _materialTextureSlot = LuaAPI.xlua_tointeger(L, 1);
                    
                    UnityEngine.Texture.SetStreamingTextureMaterialDebugProperties( _materialTextureSlot );
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Texture.SetStreamingTextureMaterialDebugProperties!");
        ...
        static int _g_get_filterMode(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Texture gen_to_be_invoked = (UnityEngine.Texture)translator.FastGetCSObj(L, 1);
                translator.PushUnityEngineFilterMode(L, gen_to_be_invoked.filterMode);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_graphicsTexture(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                UnityEngine.Texture gen_to_be_invoked = (UnityEngine.Texture)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.graphicsTexture);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
